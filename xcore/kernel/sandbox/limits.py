...
class RateLimiter:
    ...
    def check(self, plugin_name: str) -> None:
        """
        Vérifie le quota du plugin. Synchronisé car toutes les opérations sont
        en mémoire et sans await, ce qui évite l'overhead d'asyncio.
        """
        now = time.monotonic()
