...
from xcore.kernel.security.signature import SignatureError, sign_plugin, verify_plugin
...
def test_signature_bypass_outside_src(tmp_path):
    ...
    # After the fix, verify_plugin must raise SignatureError when app/main.py
    # is modified.
